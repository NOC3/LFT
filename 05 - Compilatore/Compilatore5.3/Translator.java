    ...
    void bexprp(int label_t,int label_f){
        ...
        switch(((Word)look).lexeme){
            case "==":
                ...
                expr();
                expr();
                code.emit(OpCode.if_icmpne, label_f);
                break;
            case ">":
                match(Tag.RELOP);
                expr();
                expr();
                code.emit(OpCode.if_icmple, label_f);
                break;
            case "<":
                match(Tag.RELOP);
                expr();
                expr();
                code.emit(OpCode.if_icmpge, label_f);
                break;
            case ">=":
                match(Tag.RELOP);
                expr();
                expr();
                code.emit(OpCode.if_icmplt, label_f);
                break;
            case "<=":
                match(Tag.RELOP);
                expr();
                expr();
                code.emit(OpCode.if_icmpgt, label_f);
                break;
            case "<>": //!=
                match(Tag.RELOP);
                expr();
                expr();
                code.emit(OpCode.if_icmpeq, label_f);
                break;
            default:
